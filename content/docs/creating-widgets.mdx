...
![Step 1: Access an Existing Dashboard](/images/access-dashboard.png)

### 2. **Add a New Widget**
- Click on **Add Widget**.
- Choose the type of widget to add (e.g., Graph, Problems, Map, Clock).

![Step 2: Add a New Widget](/images/add-widget.png)
...
![Step 3: Configure Widget Settings](/images/configure-widget.png)
...
![Example: Adding a CPU Usage Graph Widget](/images/cpu-graph-widget.png)

### 4. **Save the Widget**
- Click **Apply** to apply the changes.

![Step 4: Save the Dashboard](/images/save-dash.png)
